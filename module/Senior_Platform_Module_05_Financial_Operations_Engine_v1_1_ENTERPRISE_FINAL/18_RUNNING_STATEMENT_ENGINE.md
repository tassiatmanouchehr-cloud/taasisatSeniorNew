...
# 18 — Running Stakeholder Statement Engine

## Definition

Running Stakeholder Statement Engine is a Module 05 sub-engine responsible for stakeholder-readable rows, pending operational rows, ledger-based finalized rows, stable display rows, balance calculation.

## Responsibilities

- Stakeholder-readable rows.
- Pending operational rows.
- Ledger-based finalized rows.
- Stable display rows.
- Balance calculation.
...
- `running_stakeholder_statement_engine_started`
- `running_stakeholder_statement_engine_policy_resolved`
- `running_stakeholder_statement_engine_completed`
- `running_stakeholder_statement_engine_failed`
