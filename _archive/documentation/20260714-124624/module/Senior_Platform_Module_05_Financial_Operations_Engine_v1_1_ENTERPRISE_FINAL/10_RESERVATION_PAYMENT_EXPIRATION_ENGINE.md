...
# 10 — Reservation & Payment Expiration Engine

## Definition

Reservation & Payment Expiration Engine is a Module 05 sub-engine responsible for payment deadline creation, extension history, expiration policy, reservation release, audit and notifications.
...
- `reservation_and_payment_expiration_engine_started`
- `reservation_and_payment_expiration_engine_policy_resolved`
- `reservation_and_payment_expiration_engine_completed`
- `reservation_and_payment_expiration_engine_failed`
