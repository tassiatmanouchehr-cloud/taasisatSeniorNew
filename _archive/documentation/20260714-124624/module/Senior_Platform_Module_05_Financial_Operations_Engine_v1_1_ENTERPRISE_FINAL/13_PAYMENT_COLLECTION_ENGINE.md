...
# 13 — Payment Collection Engine

## Definition

Payment Collection Engine is a Module 05 sub-engine responsible for online payment, cash collection, wallet debit, collector separation, payment link lifecycle.
...
- `payment_collection_engine_started`
- `payment_collection_engine_policy_resolved`
- `payment_collection_engine_completed`
- `payment_collection_engine_failed`
