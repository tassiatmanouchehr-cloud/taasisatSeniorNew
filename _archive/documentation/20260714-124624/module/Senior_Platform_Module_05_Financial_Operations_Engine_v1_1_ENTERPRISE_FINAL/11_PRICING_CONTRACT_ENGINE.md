...
# 11 — Pricing & Contract Engine

## Definition

Pricing & Contract Engine is a Module 05 sub-engine responsible for accepted offer snapshot, contract amount lock, incorrect price resolution, archived offers, future line item support.

## Responsibilities

- Accepted offer snapshot.
- Contract amount lock.
- Incorrect price resolution.
- Archived offers.
- Future line item support.
...
- `pricing_and_contract_engine_started`
- `pricing_and_contract_engine_policy_resolved`
- `pricing_and_contract_engine_completed`
- `pricing_and_contract_engine_failed`
...
## v1.1 Commercial Lifecycle Correction

Commercial lifecycle must distinguish between Offer and Contract.
...
Unaccepted offers are archived, not deleted, and may be reactivated if reservation expires.
