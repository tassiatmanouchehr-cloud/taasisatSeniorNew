...
# 16 — Commission & Payable Allocation Engine

## Definition

Commission & Payable Allocation Engine is a Module 05 sub-engine responsible for platform commission, organization commission, provider payable, gross/net base selection, supplemental document policies.
...
- Provider payable.
- Gross/net base selection.
- Supplemental document policies.
...
- `commission_and_payable_allocation_engine_started`
- `commission_and_payable_allocation_engine_policy_resolved`
- `commission_and_payable_allocation_engine_completed`
- `commission_and_payable_allocation_engine_failed`
