...
Escrow Engine is a Module 05 sub-engine responsible for escrow creation, held money ownership, release eligibility, partial release/refund, escrow closure.

## Responsibilities

- Escrow creation.
- Held money ownership.
- Release eligibility.
...
- `escrow_engine_started`
- `escrow_engine_policy_resolved`
- `escrow_engine_completed`
- `escrow_engine_failed`
