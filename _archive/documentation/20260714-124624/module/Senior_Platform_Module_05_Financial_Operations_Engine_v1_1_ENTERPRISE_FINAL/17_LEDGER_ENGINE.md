...
# 17 — Immutable Financial Ledger Engine

## Definition

Immutable Financial Ledger Engine is a Module 05 sub-engine responsible for append-only entries, journal grouping, debit/credit integrity, reversal and adjustment, audit traceability.
...
- `immutable_financial_ledger_engine_started`
- `immutable_financial_ledger_engine_policy_resolved`
- `immutable_financial_ledger_engine_completed`
- `immutable_financial_ledger_engine_failed`
