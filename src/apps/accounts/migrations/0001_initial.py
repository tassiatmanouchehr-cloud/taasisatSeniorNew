    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("person", models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="customer_profile", to="kernel.person")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("city", models.CharField(blank=True, max_length=100)),
                ("provider_type", models.CharField(choices=[("independent", "Independent"), ("organization_affiliated", "Organization Affiliated")], default="independent", max_length=30)),
                ("status", models.CharField(choices=[("active", "Active"), ("suspended", "Suspended"), ("deactivated", "Deactivated")], default="active", max_length=20)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("person", models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="caregiver_profile", to="kernel.person")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("code", models.CharField(db_index=True, help_text="Unique organization code for caregiver affiliation requests.", max_length=50, unique=True)),
                ...
                ("tenant", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name="organizations", to="kernel.tenant")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("caregiver_profile", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="affiliation_requests", to="accounts.caregiverprofile")),
                ("organization", models.ForeignKey(blank=True, help_text="Resolved organization if code matched.", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="affiliation_requests", to="accounts.organizationprofile")),
                ("reviewed_by", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="reviewed_affiliations", to=settings.AUTH_USER_MODEL)),
            ],
            options={
