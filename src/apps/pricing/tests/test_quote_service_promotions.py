...
class QuoteServicePromotionTest(PricingTestCase):
    ...
    def test_min_amount_condition_blocks_promotion_below_threshold(self):
        ...
        PromotionService.add_condition(
            promotion=promotion,
            condition_type=PromotionConditionType.MIN_AMOUNT,
    ...
    def test_service_category_condition_scopes_promotion(self):
        ...
        PromotionService.add_condition(
            promotion=promotion,
            condition_type=PromotionConditionType.SERVICE_CATEGORY,
            service_category=self.category,
        )
        PromotionService.add_effect(
            promotion=promotion,
    ...
    def test_supplier_condition_scopes_promotion(self):
        ...
        PromotionService.add_condition(
            promotion=promotion,
            condition_type=PromotionConditionType.SUPPLIER,
            supplier=supplier,
        )
        PromotionService.add_effect(
            promotion=promotion,
    ...
    def test_promotion_ordering_stackable_then_nonstackable_stops_afterward(self):
        ...
        PromotionService.add_effect(
            promotion=exclusive_second,
            effect_type=PromotionEffectType.FIXED_DISCOUNT,
            fixed_amount=Decimal("7000"),
        )
