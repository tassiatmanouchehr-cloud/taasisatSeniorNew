...
urlpatterns = [
    ...
    path(
        "company/requests/<uuid:request_id>/cancel/", views.company_request_cancel_view, name="company-request-cancel"
    ),
    path(
        "company/invitations/<uuid:membership_id>/accept/",
        views.company_invitation_accept_view,
        name="company-invitation-accept",
    ),
    path(
        "company/invitations/<uuid:membership_id>/decline/",
        views.company_invitation_decline_view,
        name="company-invitation-decline",
    ),
