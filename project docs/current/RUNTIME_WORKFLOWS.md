...
| 34 | Customer Favorites and Saved Providers (save/unsave from public profile, "My Favorites" portal list) | IMPLEMENTED (Sprint 4.1 — **PR open, not yet merged**) | `accounts/services/favorites.py:FavoritesService` |
