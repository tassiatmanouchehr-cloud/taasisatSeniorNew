...
**Last verified HEAD:** main @ d50f83fb7aa2f71c50bb039c8259397740bc832b (PR #15 merged — **Phase 3 FORMALLY CLOSED**); active work branch `phase4-customer-favorites` — **Phase 4 — Sprint 4.1: Customer Favorites and Saved Providers is IMPLEMENTED** (new `Favorite` model, `FavoritesService`, public-profile favorite toggle, `/portal/favorites/` list page), 54 new tests, full regression 2246/2246 green, **PR open against `main`, not yet merged.** No later Phase 4 sprint has started.
**Last verified date:** 2026-07-16 (Sprint 4.1 implementation complete, pre-PR-merge)
...
| Total test methods | 2,246 (2,192 baseline after PR #14/#15 + **54 net from Sprint 4.1** — full regression run once and green, not yet merged) |
