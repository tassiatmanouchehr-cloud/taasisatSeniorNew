...
| **organization_portal** | 0 | 1 (presentation) | 23 (+5 affiliation-management views Sprint 3.1: invite, invitation-cancel, affiliation-request-approve, affiliation-request-reject, staff-terminate) | 60 (+2 Phase 1.3, +9 Sprint 3.1 `test_affiliation_management.py`) | COMPLETE |
