...
| Default branch | main |
| main HEAD SHA | b78d6a293ab90831c10b2a8ad1d1d49aab06fa86 (merge of PR #14) |
| Feature branch HEAD | none — `phase3-company-public-directory` merged to `main` via PR #14; no active feature branch |
...
| Active work branch | none — `main` is the current branch; Sprint 3.3 is CLOSED and merged; Sprint 3.4 has not started |
