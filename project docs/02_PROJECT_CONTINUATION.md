...
| Default branch | main |
| main HEAD SHA | 9929da5a5c6c109232bc4931db549848a04521e2 (post-merge doc-sync commit after PR #13's merge `49b643e`) |
| Feature branch HEAD | `phase3-company-public-directory` — Sprint 3.3 implemented, PR open against `main`, not yet merged |
...
| Active work branch | `phase3-company-public-directory` — Sprint 3.3 implemented, PR open against `main`, awaiting review; not to be merged without explicit instruction |
