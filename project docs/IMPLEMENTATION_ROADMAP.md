...
**Enterprise Baseline update:** 2026-07-20 — a full, evidence-only, eight-domain repository gap assessment was performed against `main` @ `8ee1c6772996ee92c9490ae780ab9f86e91b5ab1` and adopted as the project's official baseline; see `project docs/current/PROJECT_BASELINE.md` (living) and `project docs/assessments/2026-07-20_ENTERPRISE_BASELINE.md` (immutable evidence). **The assessment's own risk ranking identified RBAC Enforcement-Toggle Visibility & Audit Remediation as Critical — that remediation was already implemented via PR #24 (merge commit `88b39bc`, 2026-07-20) before the baseline document was committed. Documentation has now been synchronized. The immediate next activity is the Marketplace Order Workflow Architecture Assessment.**
...
| RBAC toggle audit (FR-002) | **RESOLVED 2026-07-20** — implemented via PR #24 (merge commit `88b39bc`, 2026-07-20), a cross-cutting security remediation. Admin portal status page, audited management command, architecture guardrail tests. Full regression 2517/2517 at merge. See `project docs/current/PROJECT_BASELINE.md` §17 (marked COMPLETED) |
