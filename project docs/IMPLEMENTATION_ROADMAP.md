...
**Sprint 2.3 update:** 2026-07-15 — professional credibility layer (precise verification badges, skill/experience visibility toggles, derived highlights, owner-facing "expiring soon" state, self-declared/verified distinction) implemented on branch `phase2-caregiver-credentials-skills-experience-ui` (from main @ `f7b7b2b`); zero new migration; PR to be created, not yet merged
...
### PHASE 2 — Caregiver Profile (Phase 2.1 + Sprint 2.2 gallery + Sprint 2.3 credibility layer complete; availability/dashboard/financial/orders remain)
