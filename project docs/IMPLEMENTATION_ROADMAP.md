...
### PHASE 2 — Caregiver Profile (Phase 2.1 + Sprint 2.2 gallery + Sprint 2.3 credibility layer + Sprint 2.4 availability complete; dashboard/financial/orders remain)

**Scope:** Instagram-like public profile: gallery (new model + upload service + moderation flag), certificates (surface VERIFIED `VerificationDocument`s of certificate/license types), structured skills, experience, reviews (exists), availability display (COMPLETE — Sprint 2.4), financial overview (extend earnings), orders + history.
